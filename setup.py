...
PACKAGENAME = metadata.get('package_name', 'mockspec')
DESCRIPTION = metadata.get('description', 'Generates and analyzes synthetic spectra')
AUTHOR = metadata.get('author', 'Rachel Vander Vliet')
...
if sys.version_info < tuple((int(val) for val in __minimum_python_version__.split('.'))):
    sys.stderr.write("ERROR: mockspec requires Python {} or later\n".format(__minimum_python_version__))
    sys.exit(1)
